...
static BUNDLED_ASSETS: &[(&str, &[u8])] = &[
    ...
    bundled_icon!("chat-menu-new-channel.svg"),
    bundled_icon!("chat-menu-contacts.svg"),
    bundled_icon!("chat-menu-calls.svg"),
    bundled_icon!("chat-menu-favorites.svg"),
    // Media editor (Telegram PhotoEditor parity; see assets/media-edit/ORIGIN.md)
    bundled_icon!("media-edit-ratio.svg"),
    bundled_icon!("media-edit-shapes.svg"),
    bundled_icon!("media-edit-undo.svg"),
    bundled_icon!("media-edit-redo.svg"),
    bundled_icon!("media-edit-shape-arrow.svg"),
    bundled_icon!("media-edit-shape-circle.svg"),
    bundled_icon!("media-edit-shape-rectangle.svg"),
    bundled_icon!("media-edit-shape-star.svg"),
    bundled_icon!("media-edit-shape-bubble.svg"),
    bundled_icon!("media-edit-shape-circle-fill.svg"),
    bundled_icon!("media-edit-shape-rectangle-fill.svg"),
    bundled_icon!("media-edit-shape-star-fill.svg"),
    bundled_icon!("media-edit-shape-bubble-fill.svg"),
    bundled_icon!("media-edit-tool-pen.svg"),
    bundled_icon!("media-edit-tool-marker.svg"),
    bundled_icon!("media-edit-tool-blur.svg"),
    bundled_icon!("media-edit-tool-eraser.svg"),
    bundled_icon!("media-edit-paint.svg"),
    bundled_icon!("media-edit-stickers.svg"),
    bundled_icon!("media-edit-flip.svg"),
    bundled_icon!("media-edit-rotate.svg"),
    bundled_tool_icon!("media-edit-flip.png"),
